...
export const getContactSchema = (t: TFunction<"validation">) => z.object({
...
export const getWordGuesserSchema = (t: TFunction<"validation">) => z.object({
     guess: z.string().min(1,t("answer.isShort")).max(150,t("answer.isLong")).trim()
})

export const getNumberGuesserSchema = (t: TFunction<"validation">) => z.object({
     guess: z.string()
...
export const getInteractiveMathSchema = (t: TFunction<"validation">) => z.object({
